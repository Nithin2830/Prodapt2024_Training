...
public class FriendShipFinder {
	public static void main(String[] args) {
		...
		friendslist.add(new FriendshipareaCriteria<>("nithin", "salem"));
		friendslist.add(new FriendshipareaCriteria<>("neha", "salem"));
		friendslist.add(new FriendshipareaCriteria<>("sudharshan", "salem"));
		...
		friendslist1.add(new FriendshipageCriteria<>("nithin", 22));
		friendslist1.add(new FriendshipageCriteria<>("neha", 21));
		friendslist1.add(new FriendshipageCriteria<>("sudharshan", 25));
